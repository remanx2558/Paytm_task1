...
//
//                ArrayList<Integer>genOfMovie=Movie.get(i).genres;
//
...
//            if(Movie.containsKey(i)){
//
//               String date=Movie.get(i).releaseDate;
...
//        for(int i=0;i<1683;i++){
//            if(Movie.containsKey(i)){
//                Traversal.Movie curr=Movie.get(i);
//
//
...
//                if(dateBroken.length>2 && dateBroken[2].length()==4) {
//                    int year = Integer.parseInt(dateBroken[2]);
//                    ArrayList<Integer> genraList=curr.genres;
...
//                ArrayList<Integer>genraList=Movie.get(i).genres;
//                for(int j=0;j<genraList.size();j++){
//                    int G=genraList.get(j);
