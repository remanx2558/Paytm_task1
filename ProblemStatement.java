...
//        int n=s.nextInt();
//        for(int p=0;p<n;p++){
//            System.out.println("Ender Uid for User :");
//            int uid=s.nextInt();
//            GetMovies(uid);
//        }
//
...
//        for(int i = 0; i< list_ratings.size(); i++){
//            Rating curr= list_ratings.get(i);
//            int uid=curr.userId;
//            int mid=curr.movieId;
...
//            Rating curr= list_ratings.get(i);
//
//            int rating=curr.rating;
//            int mid=curr.movieId;
//
//            ////Part 4: Get Genre Related to Movies Seen by User
//            if(Movie.containsKey(mid)){
//
//                ArrayList<Integer>movie_generas=Movie.get(mid).genres;
//
//
...
//                ArrayList<Integer>genreList1=Movie.get(mid1).genres;
//
//
...
//                ArrayList<Integer>genreList2=Movie.get(mid2).genres;
//
//
//                //// Get All Genras Related to a movie
